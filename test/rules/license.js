...
test('license - missing', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/license/error0.md',
  })
...
test('license - empty', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/license/error1.md',
  })
  t.deepEqual(messages, [
    // {
...
test('license - not last section', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/license/error2.md',
  })
  t.deepEqual(messages, [
    {
      line: 11,
...
test('license - incorrect heading depth', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/license/error3.md',
  })
  t.deepEqual(messages, [
    {
      line: 11,
...
test('license - png image', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/license/error4.md',
  })
  t.deepEqual(messages, [
    {
      line: 3,
...
test('license - success', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/license/success0.md',
  })
  t.deepEqual(messages, [])
})
