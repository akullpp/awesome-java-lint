...
test('code-of-conduct - invalid if has placeholder', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/code-of-conduct/error1/readme.md',
  })
  t.deepEqual(messages, [
    {
      line: 58,
...
test('code-of-conduct - invalid if just copyed', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/code-of-conduct/error2/readme.md',
  })
  t.deepEqual(messages, [
    {
      line: 57,
...
test('code-of-conduct - valid if missing', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/code-of-conduct/valid0/readme.md',
  })
  t.deepEqual(messages, [])
})
...
test('code-of-conduct - valid if replaced', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/code-of-conduct/valid1/readme.md',
  })
  t.deepEqual(messages, [])
})
...
test('code-of-conduct - valid if is sindresorhus himself', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/code-of-conduct/valid2/readme.md',
  })
  t.deepEqual(messages, [])
})
...
test('code-of-conduct - valid with another file name', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/code-of-conduct/valid3/readme.md',
  })
  t.deepEqual(messages, [])
})
...
test('code-of-conduct - valid with another folder', async t => {
  const messages = await lint({
    config,
    filename: 'test/fixtures/code-of-conduct/valid4/readme.md',
  })
  t.deepEqual(messages, [])
})
